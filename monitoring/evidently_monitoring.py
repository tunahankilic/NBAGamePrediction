...
def calculate_metrics_postgresql(curr, i):
    ...
    current_data = raw_data[(raw_data['date'] >= target_date) & (raw_data['date'] < (target_date + datetime.timedelta(1)))]
    ...
    fg_nopp_10_summary = result['metrics'][3]['result']['current_characteristics']['p50']
    ...
    curr.execute(
	    	...
	    	(begin + datetime.timedelta(i), num_drifted_columns, share_missing_values, fg_opp_10_summary, fg_nopp_10_summary, fg_opp_10_col_drift, fg_nopp_10_col_drift)
	)
